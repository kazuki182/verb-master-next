...
export const verbs: Verb[] = [
  ...
  },
  {
    ...
    "phrasalVerbs": [
      ...
      {"phrase": "sell off", "ja": "売り払う・処分販売する", "image": "残っている在庫や資産をまとめて売る。", "pattern": "sell off", "examples": [{"en": "We sold off old stock before the new model arrived.", "ja": "新モデルが届く前に古い在庫を処分販売しました。", "focus": "sold off", "object": "old stock"}, {"en": "The company plans to sell off unused equipment.", "ja": "その会社は未使用の機器を売却する予定です。", "focus": "sell off", "object": "unused equipment"}], "dailyExamples": []},
      {"phrase": "sell on", "ja": "転売する・さらに売る", "image": "買ったものを別の相手へさらに売る。", "pattern": "sell on", "examples": [{"en": "The distributor sells on our products to local shops.", "ja": "その販売代理店は私たちの商品を地元店舗へさらに販売しています。", "focus": "sells on", "object": "our products"}, {"en": "They bought the units and sold them on to another client.", "ja": "彼らはそのユニットを購入し、別の顧客へ転売しました。", "focus": "sold on", "object": "them"}], "dailyExamples": []},
      {"phrase": "sell into", "ja": "〜の市場へ売り込む", "image": "新しい市場や業界の中へ商品を入れていく。", "pattern": "sell into", "examples": [{"en": "We plan to sell into the hotel market next year.", "ja": "私たちは来年ホテル市場へ売り込む予定です。", "focus": "sell into", "object": "the hotel market"}, {"en": "This model sells well into high-end retail projects.", "ja": "このモデルは高級小売案件向けによく販売できます。", "focus": "sells into", "object": "high-end retail projects"}], "dailyExamples": []},
      {"phrase": "sell through", "ja": "店頭で売れる・販売が進む", "image": "商品が販売経路を通って実際に顧客へ売れていく。", "pattern": "sell through", "examples": [{"en": "The new model sold through faster than expected.", "ja": "新モデルは予想より早く販売が進みました。", "focus": "sold through"}, {"en": "We need to check how quickly this product sells through.", "ja": "この商品がどれくらい早く売れるか確認する必要があります。", "focus": "sells through"}], "dailyExamples": []},
      {"phrase": "sell against", "ja": "競合と比較して売る", "image": "競合商品と比べながら、自社商品の価値を伝える。", "pattern": "sell against", "examples": [{"en": "We need clear points to sell against cheaper competitors.", "ja": "安い競合に対して売るための明確なポイントが必要です。", "focus": "sell against", "object": "cheaper competitors"}, {"en": "This feature helps us sell against imported products.", "ja": "この機能は輸入品と比較して販売する時に役立ちます。", "focus": "sell against", "object": "imported products"}], "dailyExamples": []}
    ]
  },
  {
    "id": "choose",
    ...
    "collocations": [],
    "phrasalVerbs": [
      {"phrase": "choose from", "ja": "〜の中から選ぶ", "image": "複数の候補の中から1つを取り出す。", "pattern": "choose from", "examples": [{"en": "The client can choose from three color options.", "ja": "顧客は3つの色の選択肢から選べます。", "focus": "choose from", "object": "three color options"}, {"en": "Please choose from the models on this list.", "ja": "このリストの型番から選んでください。", "focus": "choose from", "object": "the models"}], "dailyExamples": []},
      {"phrase": "choose between", "ja": "〜の間で選ぶ", "image": "2つ、または限られた候補の間で判断する。", "pattern": "choose between", "examples": [{"en": "We need to choose between the two suppliers.", "ja": "私たちは2社の仕入先の間で選ぶ必要があります。", "focus": "choose between", "object": "the two suppliers"}, {"en": "The client chose between price and delivery speed.", "ja": "顧客は価格と納期の速さの間で選びました。", "focus": "chose between", "object": "price and delivery speed"}], "dailyExamples": []},
      {"phrase": "choose among", "ja": "〜の中から選ぶ", "image": "3つ以上の候補の中から選ぶ。", "pattern": "choose among", "examples": [{"en": "We chose among several layout plans.", "ja": "私たちは複数のレイアウト案の中から選びました。", "focus": "chose among", "object": "several layout plans"}, {"en": "The buyer must choose among many similar products.", "ja": "買い手は多くの似た商品から選ばなければなりません。", "focus": "choose among", "object": "many similar products"}], "dailyExamples": []},
      {"phrase": "choose for", "ja": "〜のために選ぶ", "image": "目的や相手に合うものを選ぶ。", "pattern": "choose for", "examples": [{"en": "We chose this product for the hotel project.", "ja": "私たちはホテル案件のためにこの商品を選びました。", "focus": "chose for", "object": "this product"}, {"en": "Please choose a sample for the client meeting.", "ja": "顧客との打ち合わせ用にサンプルを選んでください。", "focus": "choose for", "object": "a sample"}], "dailyExamples": []},
      {"phrase": "choose over", "ja": "〜より…を選ぶ", "image": "比較した上で、一方をもう一方より優先する。", "pattern": "choose A over B", "examples": [{"en": "The client chose quality over price.", "ja": "顧客は価格より品質を選びました。", "focus": "chose over", "object": "quality"}, {"en": "We chose this supplier over the cheaper one.", "ja": "私たちは安い方よりこの仕入先を選びました。", "focus": "chose over", "object": "this supplier"}], "dailyExamples": []}
    ]
  },
  {
    "id": "follow",
    ...
    "collocations": [],
    "phrasalVerbs": [
      {"phrase": "follow up", "ja": "追加確認する・後追いする", "image": "一度の連絡や作業の後に、続けて確認する。", "pattern": "follow up", "examples": [{"en": "I will follow up after the meeting.", "ja": "会議後に追加確認します。", "focus": "follow up"}, {"en": "Please follow up if the client does not reply.", "ja": "顧客から返信がない場合は後追いしてください。", "focus": "follow up"}], "dailyExamples": []},
      {"phrase": "follow up on", "ja": "〜について追加確認する", "image": "特定の案件や依頼を後から確認する。", "pattern": "follow up on", "examples": [{"en": "I will follow up on the quotation tomorrow.", "ja": "明日、その見積について追加確認します。", "focus": "follow up on", "object": "the quotation"}, {"en": "Can you follow up on the delivery date?", "ja": "納期について追加確認してもらえますか？", "focus": "follow up on", "object": "the delivery date"}], "dailyExamples": []},
      {"phrase": "follow through", "ja": "最後までやり切る", "image": "始めたことを途中で止めずに完了まで進める。", "pattern": "follow through", "examples": [{"en": "We need to follow through after the proposal.", "ja": "提案後も最後まで対応する必要があります。", "focus": "follow through"}, {"en": "The team followed through and solved the issue.", "ja": "チームは最後までやり切り、問題を解決しました。", "focus": "followed through"}], "dailyExamples": []},
      {"phrase": "follow through on", "ja": "〜を最後まで実行する", "image": "約束や計画を最後まで実行する。", "pattern": "follow through on", "examples": [{"en": "Please follow through on the client's request.", "ja": "顧客の依頼を最後まで対応してください。", "focus": "follow through on", "object": "the client's request"}, {"en": "We followed through on the action items.", "ja": "私たちは対応事項を最後まで実行しました。", "focus": "followed through on", "object": "the action items"}], "dailyExamples": []},
      {"phrase": "follow on", "ja": "続いて起こる・続く", "image": "前の出来事に続いて次のことが起きる。", "pattern": "follow on", "examples": [{"en": "A second order followed on from the first project.", "ja": "最初の案件に続いて2回目の注文がありました。", "focus": "followed on"}, {"en": "The next meeting will follow on after the site check.", "ja": "次の会議は現場確認の後に続きます。", "focus": "follow on"}], "dailyExamples": []},
      {"phrase": "follow along", "ja": "一緒についていく・手順に合わせる", "image": "説明や手順に合わせて同じ流れで進む。", "pattern": "follow along", "examples": [{"en": "Please follow along while I explain the process.", "ja": "手順を説明している間、一緒に確認してください。", "focus": "follow along"}, {"en": "The new staff followed along during the training.", "ja": "新しいスタッフは研修中、説明に合わせてついていきました。", "focus": "followed along"}], "dailyExamples": []},
      {"phrase": "follow after", "ja": "後に続く", "image": "前にいる人や前の出来事の後を追う。", "pattern": "follow after", "examples": [{"en": "The installation team followed after the survey team.", "ja": "施工チームは調査チームの後に続きました。", "focus": "followed after", "object": "the survey team"}, {"en": "Several questions followed after the presentation.", "ja": "プレゼン後にいくつか質問が続きました。", "focus": "followed after", "object": "the presentation"}], "dailyExamples": []},
      {"phrase": "follow from", "ja": "〜から当然生じる", "image": "前の事実や条件から自然に結果が出る。", "pattern": "follow from", "examples": [{"en": "This decision follows from the client's new budget.", "ja": "この決定は顧客の新しい予算から当然生じています。", "focus": "follows from", "object": "the client's new budget"}, {"en": "The schedule change followed from the delivery delay.", "ja": "納品遅れからスケジュール変更が生じました。", "focus": "followed from", "object": "the delivery delay"}], "dailyExamples": []}
    ]
  },
  {
    "id": "create",
    ...
    "meanings": [
      {"id": "create-document", "title": "① 資料・レポートを作成する", "pattern": "create + document / report", "transitivity": "他動詞", "structure": "基本", "image": "情報をまとめて新しい資料として形にする。", "point": "create a document / create a report は仕事で使いやすい基本表現です。", "examples": [
        {"en": "We need to create a document by Friday.", "ja": "私たちは金曜日までに資料を作成する必要があります。", "focus": "create", "object": "a document"},
      ...
      {"id": "create-quotation", "title": "② 見積・提案を作成する", "pattern": "create + quotation / proposal", "transitivity": "他動詞", "structure": "基本", "image": "顧客に出す見積や提案を新しく作る。", "point": "create a quotation は営業でそのまま使える表現です。", "examples": [
        {"en": "Can you create a quotation for this product?", "ja": "この製品の見積を作成できますか？", "focus": "create", "object": "a quotation"},
        {"en": "We created a proposal based on the client's request.", "ja": "私たちは顧客の依頼に基づいて提案書を作成しました。", "focus": "created", "object": "a proposal"},
        {"en": "The team is creating a new sales plan.", "ja": "チームは新しい営業計画を作成しています。", "focus": "creating", "object": "a new sales plan"}
      ], "dailyExamples": []},
      {"id": "create-value", "title": "③ 価値・機会を生み出す", "pattern": "create + value / opportunity", "transitivity": "他動詞", "structure": "基本", "image": "相手にとって役立つ価値やチャンスを作る。", "point": "create value / create opportunities は提案や営業で便利です。", "examples": [
        {"en": "This solution creates value for the client.", "ja": "この解決策は顧客に価値を生み出します。", "focus": "creates", "object": "value"},
        {"en": "The new product created an opportunity for us.", "ja": "その新製品は私たちに機会を生み出しました。", "focus": "created", "object": "an opportunity"},
    ...
    "phrasalVerbs": [
      ...
      {"phrase": "create with", "ja": "〜を使って作る", "image": "道具や素材を使って作る。", "pattern": "create A with B", "examples": [{"en": "She created the report with sales data.", "ja": "彼女は売上データを使って報告書を作成しました。", "focus": "created with", "object": "the report"}], "dailyExamples": []},
  ...
  },
  {
    ...
    "meanings": [
      ...
      {"id": "reach-target", "title": "② 目標・数字に達する", "pattern": "reach + target / number", "transitivity": "他動詞", "structure": "基本", "image": "数字や目標のラインまで届く。", "point": "reach the target は売上や進捗の説明で便利です。", "examples": [
        {"en": "We reached the sales target this month.", "ja": "私たちは今月、売上目標に達しました。", "focus": "reached", "object": "the sales target"},
        {"en": "The total cost reached five million yen.", "ja": "総費用は500万円に達しました。", "focus": "reached", "object": "five million yen"},
        {"en": "The temperature reached the limit during the test.", "ja": "試験中に温度が上限に達しました。", "focus": "reached", "object": "the limit"}
      ], "dailyExamples": []},
      {"id": "reach-agreement", "title": "③ 合意・決定に至る", "pattern": "reach + agreement / decision", "transitivity": "他動詞", "structure": "基本", "image": "話し合いが結論まで届く。", "point": "reach an agreement / reach a decision は会議や交渉でよく使います。", "examples": [
        {"en": "We reached an agreement after the meeting.", "ja": "私たちは会議後に合意に至りました。", "focus": "reached", "object": "an agreement"},
        {"en": "The team reached a decision this morning.", "ja": "チームは今朝、決定に至りました。", "focus": "reached", "object": "a decision"},
        {"en": "They reached a compromise on the price.", "ja": "彼らは価格について妥協点に達しました。", "focus": "reached", "object": "a compromise"}
      ], "dailyExamples": []},
      {"id": "reach-place", "title": "④ 場所に到着する", "pattern": "reach + place", "transitivity": "他動詞", "structure": "基本", "image": "目的地まで到着する。", "point": "arrive at より直接的に『目的地へ届く』感覚です。", "examples": [
        {"en": "The truck should reach the warehouse by evening.", "ja": "そのトラックは夕方までに倉庫へ到着するはずです。", "focus": "reach", "object": "the warehouse"},
        {"en": "We reached the site before the client arrived.", "ja": "私たちは顧客が到着する前に現場へ着きました。", "focus": "reached", "object": "the site"},
        {"en": "Can you reach the office by nine?", "ja": "9時までに会社へ着けますか？", "focus": "reach", "object": "the office"}
      ], "dailyExamples": []},
      {"id": "reach-audience", "title": "⑤ 情報・商品が相手に届く", "pattern": "reach + audience / customer", "transitivity": "他動詞", "structure": "基本", "image": "情報や商品が相手のところまで届く。", "point": "reach more customers は営業・マーケティングで使いやすいです。", "examples": [
        {"en": "Our message reached the right audience.", "ja": "私たちのメッセージは適切な層に届きました。", "focus": "reached", "object": "the right audience"},
        {"en": "This product can reach more customers online.", "ja": "この製品はオンラインでより多くの顧客に届きます。", "focus": "reach", "object": "more customers"},
        {"en": "The notice reached all branches by noon.", "ja": "その通知は正午までに全支店へ届きました。", "focus": "reached", "object": "all branches"}
      ], "dailyExamples": []}
    ],
    "collocations": [],
    "phrasalVerbs": [
  ...
  },
  {
    ...
    "coreDetail": "RETURNは、人や物、連絡、結果が元の相手・場所・状態へ戻る感覚です。基本側では返す・返品する・折り返す・結果を返すを扱い、return to / return from などのまとまりは句動詞側に寄せます。",
    ...
    "meanings": [
      ...
      {"id": "return-normal", "title": "⑤ 元の状態に戻る", "pattern": "return to normal", "transitivity": "自動詞", "structure": "基本", "image": "一度変わった状態が通常の状態へ戻る。", "point": "return to normal は仕事のトラブル復旧で使いやすい表現です。", "examples": [
        {"en": "The system returned to normal after the fix.", "ja": "修正後、システムは通常状態に戻りました。", "focus": "returned", "object": "to normal"},
        {"en": "Production returned to normal this morning.", "ja": "今朝、生産は通常状態に戻りました。", "focus": "returned", "object": "to normal"},
    ...
    "phrasalVerbs": [
      ...
      {"phrase": "return by", "ja": "〜までに返す・戻る", "image": "期限や時刻までに戻る、または返す。", "pattern": "return by", "examples": [{"en": "Please return the demo unit by Monday.", "ja": "月曜日までにデモ機を返却してください。", "focus": "return by", "object": "Monday"}], "dailyExamples": []}
    ]
  },
  {
    "id": "check",
    ...
    "transitivity": "他動詞・自動詞",
    "importance": "★★★★★ 最重要",
    "core": "正しいか・問題がないかを確かめる",
    "coreDetail": "CHECKは、資料・数字・在庫・納期・相手の意向などを確認して、ミスや不安を減らす動詞です。営業、事務、現場対応で非常によく使います。",
    "coreVisual": {"from": ["不確実な情報", "資料", "在庫", "納期", "相手の回答"], "to": "確認済みの状態", "label": "不安 → 確認済み"},
    "meanings": [
      {"id": "check-stock", "title": "① 在庫・納期を確認する", "pattern": "check + stock / delivery date", "transitivity": "他動詞", "structure": "基本", "image": "注文や見積に必要な情報を確かめる。", "point": "営業では check the stock / check the delivery date が非常に重要です。", "examples": [
        {"en": "Please check the stock before accepting the order.", "ja": "注文を受ける前に在庫を確認してください。", "focus": "check", "object": "the stock"},
        {"en": "I checked the delivery date with the factory.", "ja": "私は工場に納期を確認しました。", "focus": "checked", "object": "the delivery date"},
        {"en": "We need to check the lead time before sending the quotation.", "ja": "私たちは見積を送る前に納期を確認する必要があります。", "focus": "check", "object": "the lead time"}
      ], "dailyExamples": []},
      {"id": "check-file", "title": "② 資料・見積を確認する", "pattern": "check + file / quotation / details", "transitivity": "他動詞", "structure": "基本", "image": "資料や数字に間違いがないか見る。", "point": "送信前・提出前の確認に使いやすい基本表現です。", "examples": [
        {"en": "Please check the quotation before I send it.", "ja": "私が送る前に見積書を確認してください。", "focus": "check", "object": "the quotation"},
        {"en": "She checked the details before replying to the client.", "ja": "彼女は顧客に返信する前に詳細を確認しました。", "focus": "checked", "object": "the details"},
        {"en": "Can you check the file one more time?", "ja": "そのファイルをもう一度確認してもらえますか？", "focus": "check", "object": "the file"}
      ], "dailyExamples": []},
      {"id": "check-if", "title": "③ 〜かどうか確認する", "pattern": "check if / whether + sentence", "transitivity": "他動詞", "structure": "基本", "image": "状況や事実が正しいか確認する。", "point": "check if はメールでも会話でも使いやすい形です。", "examples": [
        ...
        {"en": "We need to check if this product fits the site conditions.", "ja": "私たちはこの製品が現場条件に合うか確認する必要があります。", "focus": "check", "object": "if this product fits the site conditions"}
      ], "dailyExamples": []},
      {"id": "check-before", "title": "④ 送信・出荷前に確認する", "pattern": "check before + -ing", "transitivity": "自動詞的表現", "structure": "基本", "image": "作業の前に一度止まって確認する。", "point": "before sending / before shipping の形でミス防止に使えます。", "examples": [
        {"en": "Please check before sending the email.", "ja": "メールを送る前に確認してください。", "focus": "check", "object": "before sending the email"},
        {"en": "We checked before shipping the products.", "ja": "私たちは製品を出荷する前に確認しました。", "focus": "checked", "object": "before shipping the products"},
        {"en": "I always check before confirming the order.", "ja": "私は注文を確定する前に必ず確認します。", "focus": "check", "object": "before confirming the order"}
      ], "dailyExamples": []},
      {"id": "check-for", "title": "⑤ 問題・ミスがないか確認する", "pattern": "check for + error / damage", "transitivity": "他動詞", "structure": "基本", "image": "ミス・傷・不足などを探して確認する。", "point": "check for errors / damage / missing parts は実務でよく使います。", "examples": [
        {"en": "Please check for errors before submitting the report.", "ja": "レポートを提出する前にミスがないか確認してください。", "focus": "check", "object": "for errors"},
        {"en": "The team checked the product for damage after delivery.", "ja": "チームは納品後、製品に傷がないか確認しました。", "focus": "checked", "object": "the product for damage"},
        {"en": "We checked for missing parts before installation.", "ja": "私たちは施工前に不足部品がないか確認しました。", "focus": "checked", "object": "for missing parts"}
      ], "dailyExamples": []}
    ],
    "collocations": [],
    "phrasalVerbs": [
      {"phrase": "check in", "ja": "到着・受付する / 状況確認する", "image": "場所や状況に入って確認する。", "pattern": "check in", "examples": [{"en": "I will check in with the team tomorrow morning.", "ja": "私は明日の朝、チームに状況確認します。", "focus": "check in", "object": "with the team"}], "dailyExamples": []},
      {"phrase": "check out", "ja": "確認する・見てみる", "image": "気になるものを見て確認する。", "pattern": "check out", "examples": [{"en": "Please check out the new sample page.", "ja": "新しいサンプルページを確認してください。", "focus": "check out", "object": "the new sample page"}], "dailyExamples": []},
      {"phrase": "check up on", "ja": "〜の様子を確認する", "image": "人や状況が大丈夫か確かめる。", "pattern": "check up on", "examples": [{"en": "Can you check up on the delivery status this afternoon?", "ja": "今日の午後、納品状況を確認してもらえますか？", "focus": "check up on", "object": "the delivery status"}], "dailyExamples": []},
      {"phrase": "check with", "ja": "〜に確認する", "image": "相手に聞いて確認を取る。", "pattern": "check with", "examples": [{"en": "Please check with the customer before changing the color.", "ja": "色を変更する前に顧客へ確認してください。", "focus": "check with", "object": "the customer"}], "dailyExamples": []},
      {"phrase": "check into", "ja": "〜を調査する・詳しく確認する", "image": "問題の中に入って詳しく調べる。", "pattern": "check into", "examples": [{"en": "We need to check into the cause of the delay.", "ja": "私たちは遅延の原因を詳しく確認する必要があります。", "focus": "check into", "object": "the cause of the delay"}], "dailyExamples": []},
      {"phrase": "check over", "ja": "ざっと確認する", "image": "全体を見渡して確認する。", "pattern": "check over", "examples": [{"en": "Please check over the quotation before I send it.", "ja": "私が送る前に見積書をざっと確認してください。", "focus": "check over", "object": "the quotation"}], "dailyExamples": []},
      {"phrase": "check through", "ja": "ひと通り確認する", "image": "最初から最後まで確認する。", "pattern": "check through", "examples": [{"en": "We checked through the list before placing the order.", "ja": "私たちは発注前にリストをひと通り確認しました。", "focus": "checked through", "object": "the list"}], "dailyExamples": []},
      ...
      {"phrase": "check back", "ja": "後で再確認する", "image": "時間を置いてもう一度確認する。", "pattern": "check back", "examples": [{"en": "I will check back after the supplier replies.", "ja": "仕入先から返信が来た後、私は再度確認します。", "focus": "check back", "object": "after the supplier replies"}], "dailyExamples": []},
  ...
  },
  {
    ...
    "transitivity": "他動詞・自動詞",
    "importance": "★★★★☆ 重要",
    "core": "複数の選択肢から一つの方向を決める",
    "coreDetail": "DECIDEは、選択肢・条件・予算・予定などを比べて、次に進む方向を決める動詞です。仕事では価格、日程、製品、方針を決める時によく使います。",
    "coreVisual": {"from": ["選択肢A", "選択肢B", "条件", "予算", "予定"], "to": "決定した方向", "label": "迷い → 決定"},
    "meanings": [
      {"id": "decide-schedule", "title": "① 予定・価格を決める", "pattern": "decide + schedule / price", "transitivity": "他動詞", "structure": "基本", "image": "仕事の条件を決める。", "point": "decide the schedule / decide the price は仕事で使いやすい基本表現です。", "examples": [
        {"en": "We need to decide the schedule by Friday.", "ja": "私たちは金曜日までにスケジュールを決める必要があります。", "focus": "decide", "object": "the schedule"},
        {"en": "The manager decided the final price.", "ja": "マネージャーが最終価格を決めました。", "focus": "decided", "object": "the final price"},
        {"en": "Please decide the meeting date after checking availability.", "ja": "空き状況を確認した後、会議日を決めてください。", "focus": "decide", "object": "the meeting date"}
      ], "dailyExamples": []},
      {"id": "decide-what", "title": "② 何をするか決める", "pattern": "decide what / which / whether", "transitivity": "他動詞", "structure": "基本", "image": "次の行動や選択肢を決める。", "point": "decide what to do / decide which product to use は実用的です。", "examples": [
        {"en": "We decided what to do after the client replied.", "ja": "顧客が返信した後、私たちは何をするか決めました。", "focus": "decided", "object": "what to do"},
        {"en": "They decided which product to use for the project.", "ja": "彼らはその案件でどの製品を使うか決めました。", "focus": "decided", "object": "which product to use"},
        {"en": "I have not decided whether to visit the site tomorrow.", "ja": "私は明日現場へ行くかどうかまだ決めていません。", "focus": "decided", "object": "whether to visit the site tomorrow"}
      ], "dailyExamples": []},
      {"id": "decide-not", "title": "③ 〜しないことを決める", "pattern": "decide not to do", "transitivity": "他動詞", "structure": "基本", "image": "あえて進めない判断をする。", "point": "仕事ではリスクや条件を見て進めない判断もあります。", "examples": [
        {"en": "We decided not to proceed with the order.", "ja": "私たちはその注文を進めないことに決めました。", "focus": "decided", "object": "not to proceed with the order"},
        {"en": "The client decided not to change the design.", "ja": "顧客はデザインを変更しないことに決めました。", "focus": "decided", "object": "not to change the design"},
        {"en": "I decided not to send the quotation until the price is confirmed.", "ja": "価格が確定するまで見積を送らないことに決めました。", "focus": "decided", "object": "not to send the quotation"}
      ], "dailyExamples": []},
      {"id": "decide-based", "title": "④ 条件に基づいて決める", "pattern": "decide based on + condition", "transitivity": "自動詞的表現", "structure": "基本", "image": "予算や条件を根拠に判断する。", "point": "based on the budget / lead time / quality と相性が良いです。", "examples": [
        {"en": "We decided based on the budget.", "ja": "私たちは予算に基づいて決めました。", "focus": "decided", "object": "based on the budget"},
        {"en": "The customer decided based on the delivery date.", "ja": "顧客は納期に基づいて決めました。", "focus": "decided", "object": "based on the delivery date"},
        {"en": "Please decide based on both price and quality.", "ja": "価格と品質の両方に基づいて決めてください。", "focus": "decide", "object": "based on both price and quality"}
      ], "dailyExamples": []},
      {"id": "decide-after", "title": "⑤ 会議・確認後に決める", "pattern": "decide after + event", "transitivity": "自動詞的表現", "structure": "基本", "image": "必要な情報がそろってから判断する。", "point": "decide after the meeting / after checking は自然な仕事表現です。", "examples": [
        {"en": "Let's decide after the meeting.", "ja": "会議の後で決めましょう。", "focus": "decide", "object": "after the meeting"},
        {"en": "We decided after checking the actual site.", "ja": "私たちは実際の現場を確認した後で決めました。", "focus": "decided", "object": "after checking the actual site"},
        {"en": "The team will decide after reviewing the proposal.", "ja": "チームは提案書を確認した後で決めます。", "focus": "decide", "object": "after reviewing the proposal"}
      ], "dailyExamples": []}
    ],
    "collocations": [],
    "phrasalVerbs": [
      {"phrase": "decide on", "ja": "〜に決める", "image": "複数の候補から一つを選んで決める。", "pattern": "decide on", "examples": [{"en": "We decided on the new supplier.", "ja": "私たちは新しい仕入先に決めました。", "focus": "decided on", "object": "the new supplier"}], "dailyExamples": []},
      {"phrase": "decide between", "ja": "〜の間で決める", "image": "二つ以上の候補を比べて決める。", "pattern": "decide between", "examples": [{"en": "We need to decide between these two models.", "ja": "私たちはこの2つの型番の間で決める必要があります。", "focus": "decide between", "object": "these two models"}], "dailyExamples": []},
      {"phrase": "decide against", "ja": "〜しないことに決める", "image": "ある選択肢を採用しないと判断する。", "pattern": "decide against", "examples": [{"en": "The client decided against changing the layout.", "ja": "顧客はレイアウトを変更しないことに決めました。", "focus": "decided against", "object": "changing the layout"}], "dailyExamples": []},
      {"phrase": "decide for", "ja": "〜に有利な判断をする・〜のために決める", "image": "相手や条件に合わせて判断する。", "pattern": "decide for", "examples": [{"en": "The committee decided for the safer option.", "ja": "委員会はより安全な選択肢に決めました。", "focus": "decided for", "object": "the safer option"}], "dailyExamples": []},
      {"phrase": "decide upon", "ja": "〜に決める", "image": "少し硬めに、正式に決定する。", "pattern": "decide upon", "examples": [{"en": "We decided upon the final design after the review.", "ja": "私たちは確認後、最終デザインに決めました。", "focus": "decided upon", "object": "the final design"}], "dailyExamples": []}
    ]
  },
  {
    "id": "explain",
    ...
    "transitivity": "他動詞・自動詞",
    "importance": "★★★★☆ 重要",
    "core": "相手が分かるように理由・内容・仕組みを伝える",
    "coreDetail": "EXPLAINは、理由・変更点・問題・手順などを、相手が理解できる形で伝える動詞です。顧客説明、社内共有、トラブル報告でよく使います。",
    "coreVisual": {"from": ["理由", "問題", "変更点", "手順", "仕組み"], "to": "相手が理解した状態", "label": "不明 → 理解"},
    "meanings": [
      {"id": "explain-reason", "title": "① 理由・問題を説明する", "pattern": "explain + reason / issue", "transitivity": "他動詞", "structure": "基本", "image": "なぜそうなったかを相手に分かるように伝える。", "point": "reason, issue, problem とよく使います。", "examples": [
        {"en": "Please explain the reason for the delay.", "ja": "遅延の理由を説明してください。", "focus": "explain", "object": "the reason"},
        {"en": "I explained the issue to the customer.", "ja": "私は顧客にその問題を説明しました。", "focus": "explained", "object": "the issue"},
        {"en": "We need to explain the problem clearly.", "ja": "私たちはその問題を分かりやすく説明する必要があります。", "focus": "explain", "object": "the problem"}
      ], "dailyExamples": []},
      {"id": "explain-change", "title": "② 変更点・内容を説明する", "pattern": "explain + change / detail", "transitivity": "他動詞", "structure": "基本", "image": "変更内容や詳細を相手に伝える。", "point": "見積、仕様、納期変更の説明に使えます。", "examples": [
        {"en": "Can you explain the change to the client?", "ja": "顧客に変更点を説明してもらえますか？", "focus": "explain", "object": "the change"},
        {"en": "She explained the details of the quotation.", "ja": "彼女は見積の詳細を説明しました。", "focus": "explained", "object": "the details"},
        {"en": "We explained the new schedule during the meeting.", "ja": "私たちは会議中に新しいスケジュールを説明しました。", "focus": "explained", "object": "the new schedule"}
      ], "dailyExamples": []},
      {"id": "explain-how", "title": "③ 仕組み・方法を説明する", "pattern": "explain how + sentence", "transitivity": "他動詞", "structure": "基本", "image": "動き方や使い方を分かる形で伝える。", "point": "explain how it works は製品説明で便利です。", "examples": [
        {"en": "Please explain how the system works.", "ja": "そのシステムがどう動くか説明してください。", "focus": "explain", "object": "how the system works"},
        {"en": "I explained how to use the app.", "ja": "私はそのアプリの使い方を説明しました。", "focus": "explained", "object": "how to use the app"},
        {"en": "The engineer explained how the controller connects to the lights.", "ja": "技術者は制御機が照明にどう接続するか説明しました。", "focus": "explained", "object": "how the controller connects to the lights"}
      ], "dailyExamples": []},
      {"id": "explain-why", "title": "④ なぜ〜なのか説明する", "pattern": "explain why + sentence", "transitivity": "他動詞", "structure": "基本", "image": "理由や背景を説明する。", "point": "クレーム対応や納期説明で使いやすい形です。", "examples": [
        {"en": "We explained why the delivery was delayed.", "ja": "私たちはなぜ納品が遅れたのか説明しました。", "focus": "explained", "object": "why the delivery was delayed"},
        {"en": "Please explain why the price changed.", "ja": "なぜ価格が変わったのか説明してください。", "focus": "explain", "object": "why the price changed"},
        {"en": "He explained why we need another approval.", "ja": "彼はなぜもう一つ承認が必要なのか説明しました。", "focus": "explained", "object": "why we need another approval"}
      ], "dailyExamples": []},
      {"id": "explain-clearly", "title": "⑤ 分かりやすく説明する", "pattern": "explain clearly / simply", "transitivity": "自動詞的表現", "structure": "基本", "image": "相手が理解しやすい言い方にする。", "point": "clearly / simply と組み合わせると、説明の質を表せます。", "examples": [
        {"en": "Please explain clearly so the customer can understand.", "ja": "顧客が理解できるように分かりやすく説明してください。", "focus": "explain", "object": "clearly"},
        {"en": "She explained simply and the team understood the issue.", "ja": "彼女は簡単に説明し、チームは問題を理解しました。", "focus": "explained", "object": "simply"},
        {"en": "I will explain again if anything is unclear.", "ja": "不明点があれば私がもう一度説明します。", "focus": "explain", "object": "again"}
      ], "dailyExamples": []}
    ],
    "collocations": [],
    "phrasalVerbs": [
      {"phrase": "explain to", "ja": "〜に説明する", "image": "説明を相手へ向ける。", "pattern": "explain to", "examples": [{"en": "I explained the situation to the client.", "ja": "私は顧客に状況を説明しました。", "focus": "explained to", "object": "the client"}], "dailyExamples": []},
      {"phrase": "explain about", "ja": "〜について説明する", "image": "テーマや内容について説明する。", "pattern": "explain about", "examples": [{"en": "Can you explain about the new product line?", "ja": "新しい製品ラインについて説明してもらえますか？", "focus": "explain about", "object": "the new product line"}], "dailyExamples": []},
      {"phrase": "explain away", "ja": "言い訳してごまかす", "image": "問題を説明で小さく見せようとする。", "pattern": "explain away", "examples": [{"en": "We should not explain away the quality issue.", "ja": "品質問題をごまかすように説明するべきではありません。", "focus": "explain away", "object": "the quality issue"}], "dailyExamples": []},
      {"phrase": "explain through", "ja": "〜を通して説明する", "image": "資料や例を通して説明する。", "pattern": "explain through", "examples": [{"en": "The trainer explained through a simple example.", "ja": "講師は簡単な例を通して説明しました。", "focus": "explained through", "object": "a simple example"}], "dailyExamples": []},
      {"phrase": "explain with", "ja": "〜を使って説明する", "image": "資料・図・データを使って説明する。", "pattern": "explain with", "examples": [{"en": "Please explain with the latest drawing.", "ja": "最新の図面を使って説明してください。", "focus": "explain with", "object": "the latest drawing"}], "dailyExamples": []}
    ]
  },
  {
    "id": "improve",
  ...
  },
  {
      ...
      "transitivity": "他動詞",
      "importance": "★★★★☆ 重要",
      "core": "議題を中心に意見を出し合い、理解や判断に近づける",
      "coreDetail": "DISCUSSは、問題・条件・計画・提案などを、相手と掘り下げて話し合う動詞です。基本は discuss the issue のように目的語を直接置きます。discuss about は通常避けます。",
      ...
      "meanings": [
        {
          ...
          "image": "議題をテーブルに置き、関係者で話し合う。",
          "point": "discuss about ではなく discuss the issue が自然です。",
          "examples": [
        ...
        },
        {
          ...
          "transitivity": "他動詞",
          "structure": "S + discuss + O",
          "image": "未確定の細部を話し合って整理する。",
          "point": "details, terms, conditions は仕事でよく使う組み合わせです。",
          "examples": [
        ...
        },
        {
          ...
          "image": "複数の選択肢を比べながら判断に近づく。",
          "point": "何をどうするか未定の時に便利です。",
          "examples": [
        ...
        },
        {
          ...
          "title": "⑤ 社内で協議する",
          "pattern": "discuss + O + internally",
          "transitivity": "他動詞",
          "structure": "S + discuss + O + internally",
          "image": "顧客へ返答する前に社内で意見をそろえる。",
          "point": "internally を付けると『社内で』という営業現場で使いやすい表現になります。",
          "examples": [
            { "en": "We need to discuss the request internally first.", "ja": "私たちはまず社内でその依頼について協議する必要があります。", "focus": "discuss", "object": "the request" },
            { "en": "I will discuss the price change internally and get back to you.", "ja": "価格変更について社内で協議し、改めてご連絡します。", "focus": "discuss", "object": "the price change" },
      ...
      "phrasalVerbs": [
        ...
        { "phrase": "discuss together", "ja": "一緒に話し合う", "image": "同じ議題に向かって一緒に考える。", "pattern": "discuss together", "examples": [
          { "en": "Let's discuss the next step together.", "ja": "次の対応を一緒に話し合いましょう。", "focus": "discuss together" },
          { "en": "We discussed the proposal together before the meeting.", "ja": "私たちは会議前に提案内容を一緒に話し合いました。", "focus": "discussed together" },
          { "en": "The sales and technical teams should discuss this together.", "ja": "営業チームと技術チームはこれを一緒に話し合うべきです。", "focus": "discuss together" }
        ], "dailyExamples": [] },
        { "phrase": "discuss in", "ja": "〜の中で話し合う", "image": "会議・場・グループの中で議題を扱う。", "pattern": "discuss in + meeting / group", "examples": [
          { "en": "We will discuss the issue in tomorrow's meeting.", "ja": "私たちは明日の会議でその問題を話し合います。", "focus": "discuss in" },
          { "en": "Please discuss the schedule in the project group.", "ja": "プロジェクトグループ内でスケジュールを話し合ってください。", "focus": "discuss in" },
          { "en": "The topic was discussed in the sales meeting.", "ja": "その話題は営業会議で話し合われました。", "focus": "discuss in" }
        ], "dailyExamples": [] }
      ]
    },
  {
      ...
      "meanings": [
        ...
        { "id": "confirm-if", "title": "④ 正しいかどうか確認する", "pattern": "confirm if / whether + 文", "transitivity": "他動詞", "structure": "S + confirm + if/whether ...", "image": "不明点をYes/Noで確かめる。", "point": "confirm if it is correct は、念のため確認する時に使いやすいです。", "examples": [
          { "en": "Please confirm if the address is correct.", "ja": "住所が正しいか確認してください。", "focus": "confirm", "object": "if the address is correct" },
          { "en": "We need to confirm whether the product is available.", "ja": "私たちはその製品が入手可能か確認する必要があります。", "focus": "confirm", "object": "whether the product is available" },
          { "en": "I confirmed that the file was attached.", "ja": "私はファイルが添付されていることを確認しました。", "focus": "confirmed", "object": "that the file was attached" }
        ], "dailyExamples": [] },
        { "id": "confirm-before", "title": "⑤ 送信・出荷前に確認する", "pattern": "confirm + O + before + 動作", "transitivity": "他動詞", "structure": "S + confirm + O + M", "image": "次の作業に進む前に内容を固める。", "point": "before sending / before shipping は仕事で使いやすい形です。", "examples": [
          { "en": "Please confirm the quotation before sending it.", "ja": "送信前に見積を確認してください。", "focus": "confirm", "object": "the quotation" },
          { "en": "We confirmed the address before shipping the sample.", "ja": "私たちはサンプル出荷前に住所を確認しました。", "focus": "confirmed", "object": "the address" },
          { "en": "Confirm the final design before production starts.", "ja": "製作開始前に最終デザインを確認してください。", "focus": "Confirm", "object": "the final design" }
        ], "dailyExamples": [] }
      ],
      "collocations": [],
      "phrasalVerbs": [
        { "phrase": "confirm with", "ja": "〜に確認する", "image": "相手に聞いて内容を確かにする。", "pattern": "confirm + 内容 + with + 相手", "examples": [
          { "en": "I will confirm the delivery date with the supplier.", "ja": "仕入先に納期を確認します。", "focus": "confirm with" },
          { "en": "Please confirm the price with the client.", "ja": "顧客に価格を確認してください。", "focus": "confirm with" },
          { "en": "We confirmed the schedule with the installation team.", "ja": "私たちは施工チームにスケジュールを確認しました。", "focus": "confirmed with" }
        ], "dailyExamples": [] },
        { "phrase": "confirm by", "ja": "〜で確認する・〜までに確定する", "image": "確認する手段や期限を示す。", "pattern": "confirm by + method / time", "examples": [
          { "en": "Please confirm by email.", "ja": "メールで確認してください。", "focus": "confirm by" },
          { "en": "Can you confirm by noon?", "ja": "正午までに確定できますか？", "focus": "confirm by" },
          { "en": "The customer confirmed the order by phone.", "ja": "顧客は電話で注文を確認しました。", "focus": "confirmed by" }
        ], "dailyExamples": [] },
        { "phrase": "confirm in", "ja": "〜で確認する", "image": "文書・システム・会議の中で確認する。", "pattern": "confirm in + document / system / meeting", "examples": [
          { "en": "Please confirm the change in the document.", "ja": "資料内で変更点を確認してください。", "focus": "confirm in" },
          { "en": "We confirmed the quantity in the system.", "ja": "私たちはシステム上で数量を確認しました。", "focus": "confirmed in" },
          { "en": "The final schedule was confirmed in the meeting.", "ja": "最終スケジュールは会議で確認されました。", "focus": "confirmed in" }
        ], "dailyExamples": [] },
        { "phrase": "confirm on", "ja": "〜について確認する", "image": "特定の件・日付・条件について確認する。", "pattern": "confirm on + topic / date", "examples": [
          { "en": "Please confirm on the delivery schedule.", "ja": "納品スケジュールについて確認してください。", "focus": "confirm on" },
          { "en": "We need to confirm on the final price.", "ja": "私たちは最終価格について確認する必要があります。", "focus": "confirm on" },
          { "en": "The team confirmed on the next action.", "ja": "チームは次の対応について確認しました。", "focus": "confirmed on" }
        ], "dailyExamples": [] },
        { "phrase": "confirm through", "ja": "〜を通して確認する", "image": "人・システム・資料を通じて確認する。", "pattern": "confirm through + channel", "examples": [
          { "en": "We confirmed the order through the online system.", "ja": "私たちはオンラインシステムを通して注文を確認しました。", "focus": "confirmed through" },
          { "en": "Please confirm the details through the sales representative.", "ja": "営業担当者を通して詳細を確認してください。", "focus": "confirm through" },
          { "en": "The delivery status can be confirmed through the tracking page.", "ja": "配送状況は追跡ページを通して確認できます。", "focus": "confirmed through" }
        ], "dailyExamples": [] },
        { "phrase": "confirm against", "ja": "〜と照合して確認する", "image": "基準・リスト・注文内容と照らし合わせる。", "pattern": "confirm against + list / order / standard", "examples": [
          { "en": "Please confirm the items against the order sheet.", "ja": "注文書と照合して品目を確認してください。", "focus": "confirm against" },
          { "en": "We confirmed the shipment against the packing list.", "ja": "私たちは梱包リストと照合して出荷内容を確認しました。", "focus": "confirmed against" },
          { "en": "Confirm the final design against the approved drawing.", "ja": "承認済み図面と照合して最終デザインを確認してください。", "focus": "Confirm against" }
        ], "dailyExamples": [] }
      ]
    },
  {
      ...
      "transitivity": "他動詞",
      "importance": "★★★★☆ 重要",
      "core": "相手・外部から自分や会社側に入ってくるものを受け取る",
      "coreDetail": "RECEIVEは、メール・注文・資料・支払い・連絡などが、外側から自分側へ入ってくるイメージです。getより少し正式で、仕事メールや受領表現でよく使います。",
      "coreVisual": { "from": ["顧客", "仕入先", "外部", "相手"], "to": "自分・会社側", "label": "外から自分側へ入ってくる" },
      "meanings": [
        { "id": "receive-mail", "title": "① メール・連絡を受け取る", "pattern": "receive + email / message / call", "transitivity": "他動詞", "structure": "S + receive + O", "image": "相手から情報が届く。", "point": "receive an email は仕事でよく使う丁寧な表現です。", "examples": [
          { "en": "We received your email this morning.", "ja": "私たちは今朝あなたのメールを受け取りました。", "focus": "received", "object": "your email" },
          { "en": "Did you receive the message from the client?", "ja": "顧客からのメッセージを受け取りましたか？", "focus": "receive", "object": "the message" },
          { "en": "I received a call about the delivery schedule.", "ja": "納品スケジュールについて電話を受けました。", "focus": "received", "object": "a call" }
        ], "dailyExamples": [] },
        { "id": "receive-order", "title": "② 注文・依頼を受ける", "pattern": "receive + order / request", "transitivity": "他動詞", "structure": "S + receive + O", "image": "顧客や社内から依頼が入ってくる。", "point": "receive an order は、注文を正式に受ける場面で使えます。", "examples": [
          { "en": "We received a new order from the customer.", "ja": "私たちは顧客から新しい注文を受けました。", "focus": "received", "object": "a new order" },
          { "en": "The sales team received a request for a quotation.", "ja": "営業チームは見積依頼を受けました。", "focus": "received", "object": "a request" },
          { "en": "Please tell me when you receive the purchase order.", "ja": "注文書を受け取ったら教えてください。", "focus": "receive", "object": "the purchase order" }
        ], "dailyExamples": [] },
        { "id": "receive-document", "title": "③ 資料・サンプルを受け取る", "pattern": "receive + document / sample / file", "transitivity": "他動詞", "structure": "S + receive + O", "image": "物やデータが相手から届く。", "point": "資料・サンプル・ファイルの受領に使いやすい形です。", "examples": [
          { "en": "We received the sample yesterday.", "ja": "私たちは昨日サンプルを受け取りました。", "focus": "received", "object": "the sample" },
          { "en": "Please confirm when you receive the document.", "ja": "資料を受け取ったら確認してください。", "focus": "receive", "object": "the document" },
          { "en": "I received the updated file from the designer.", "ja": "私はデザイナーから更新されたファイルを受け取りました。", "focus": "received", "object": "the updated file" }
        ], "dailyExamples": [] },
        { "id": "receive-payment", "title": "④ 支払いを受け取る", "pattern": "receive + payment", "transitivity": "他動詞", "structure": "S + receive + O", "image": "代金や入金が会社側に入る。", "point": "receive payment は経理・営業で使いやすい表現です。", "examples": [
          { "en": "We received payment from the client today.", "ja": "私たちは本日、顧客から支払いを受け取りました。", "focus": "received", "object": "payment" },
          { "en": "The order will ship after we receive payment.", "ja": "支払いを受け取った後に注文品を出荷します。", "focus": "receive", "object": "payment" },
          { "en": "Please check whether we received the deposit.", "ja": "私たちが前金を受け取ったか確認してください。", "focus": "received", "object": "the deposit" }
        ], "dailyExamples": [] },
        { "id": "receive-feedback", "title": "⑤ フィードバック・評価を受ける", "pattern": "receive + feedback / response", "transitivity": "他動詞", "structure": "S + receive + O", "image": "相手の反応や評価が自分側に返ってくる。", "point": "receive feedback は、改善や提案後の反応でよく使います。", "examples": [
          { "en": "We received positive feedback from the client.", "ja": "私たちは顧客から良いフィードバックを受けました。", "focus": "received", "object": "positive feedback" },
          { "en": "Did you receive any response to the proposal?", "ja": "提案に対して何か返答を受け取りましたか？", "focus": "receive", "object": "any response" },
          { "en": "The new product received good reviews.", "ja": "新商品は良い評価を受けました。", "focus": "received", "object": "good reviews" }
        ], "dailyExamples": [] }
      ],
      "collocations": [],
      "phrasalVerbs": [
        { "phrase": "receive from", "ja": "〜から受け取る", "image": "受け取り元を示す。", "pattern": "receive + O + from + 相手", "examples": [
          { "en": "We received the order from the client.", "ja": "私たちは顧客から注文を受けました。", "focus": "receive from" },
          { "en": "I received the file from the designer.", "ja": "私はデザイナーからファイルを受け取りました。", "focus": "received from" },
          { "en": "Please check the sample we received from the supplier.", "ja": "仕入先から受け取ったサンプルを確認してください。", "focus": "received from" }
        ], "dailyExamples": [] },
        { "phrase": "receive by", "ja": "〜で受け取る・〜までに受け取る", "image": "手段や期限を示す。", "pattern": "receive by + method / date", "examples": [
          { "en": "We received the confirmation by email.", "ja": "私たちはメールで確認を受け取りました。", "focus": "received by" },
          { "en": "Can we receive the sample by Friday?", "ja": "金曜日までにサンプルを受け取れますか？", "focus": "receive by" },
          { "en": "The order must be received by the end of the month.", "ja": "その注文は月末までに受領される必要があります。", "focus": "received by" }
        ], "dailyExamples": [] },
        { "phrase": "receive into", "ja": "〜に受け入れる", "image": "人・物・情報を組織や場所の中に受け入れる。", "pattern": "receive + O + into + 場所/組織", "examples": [
          { "en": "The new data was received into the system.", "ja": "新しいデータはシステムに取り込まれました。", "focus": "received into" },
          { "en": "The parts were received into inventory yesterday.", "ja": "部品は昨日在庫に受け入れられました。", "focus": "received into" },
          { "en": "The visitor was received into the meeting room.", "ja": "来客は会議室に案内されました。", "focus": "received into" }
        ], "dailyExamples": [] },
        { "phrase": "receive with", "ja": "〜とともに受け取る・〜の態度で受け止める", "image": "一緒に受け取る物や受け止め方を示す。", "pattern": "receive + O + with + thing / attitude", "examples": [
          { "en": "We received the product with the inspection report.", "ja": "私たちは検査報告書と一緒に製品を受け取りました。", "focus": "received with" },
          { "en": "The proposal was received with interest.", "ja": "その提案は関心を持って受け止められました。", "focus": "received with" },
          { "en": "The announcement was received with concern by the team.", "ja": "その発表はチームに心配を持って受け止められました。", "focus": "received with" }
        ], "dailyExamples": [] },
        { "phrase": "receive through", "ja": "〜を通して受け取る", "image": "システム・窓口・人を通じて入ってくる。", "pattern": "receive + O + through + channel", "examples": [
          { "en": "We received the request through the website.", "ja": "私たちはWebサイトを通して依頼を受けました。", "focus": "received through" },
          { "en": "The sales team received the information through the distributor.", "ja": "営業チームは代理店を通してその情報を受け取りました。", "focus": "received through" },
          { "en": "You can receive updates through the system.", "ja": "システムを通して更新情報を受け取れます。", "focus": "receive through" }
        ], "dailyExamples": [] },
        { "phrase": "receive at", "ja": "〜で受け取る", "image": "受け取り場所を示す。", "pattern": "receive + O + at + place", "examples": [
          { "en": "We received the package at the office.", "ja": "私たちは会社で荷物を受け取りました。", "focus": "received at" },
          { "en": "The documents were received at the front desk.", "ja": "資料は受付で受け取られました。", "focus": "received at" },
          { "en": "Please receive the sample at the warehouse.", "ja": "倉庫でサンプルを受け取ってください。", "focus": "receive at" }
        ], "dailyExamples": [] }
      ]
    },
  {
    ...
    "coreDetail": "DELIVERは、商品・資料・サービス・成果などを、相手が受け取れる状態まで届ける動詞です。仕事では「納品する」「提供する」「成果を出す」という意味でよく使います。",
    "coreVisual": {
      "from": [
        "商品",
        "資料",
    ...
    "meanings": [
        ...
        "examples": [
          {
            ...
            "ja": "私たちは昨日、サンプルを納品しました。",
            "focus": "delivered",
            "object": "the samples"
          },
          {
            "en": "Please deliver the documents by Friday.",
            "ja": "金曜日までに資料を届けてください。",
            "focus": "deliver",
            "object": "the documents"
          },
      ...
      },
      {
        ...
        "point": "service / support / solution と一緒に、提供内容を表せます。",
        "examples": [
          {
          ...
          },
          {
            ...
            "ja": "その会社は継続顧客に信頼できるサービスを提供しています。",
            "focus": "delivers",
      ...
      },
      {
        ...
        "point": "deliver a presentation は「プレゼンを行う」という意味です。",
        "examples": [
          {
            "en": "She delivered a presentation at the customer meeting.",
            "ja": "彼女は顧客との会議でプレゼンを行いました。",
            "focus": "delivered",
      ...
      },
      {
        "id": "deliver-order",
        "title": "⑤ 注文品・完成品を納める",
        "pattern": "deliver + order/product",
        "transitivity": "他動詞",
        "structure": "S + deliver + O",
        "image": "受注した商品や完成品を顧客へ納める。",
        "point": "注文品や製作物の納品を説明する時に使います。",
        "examples": [
          {
            "en": "We delivered the full order this morning.",
            "ja": "私たちは今朝、注文品をすべて納品しました。",
            "focus": "delivered",
            "object": "the full order"
          },
          {
            "en": "The factory can deliver the finished products next week.",
            "ja": "工場は来週、完成品を納品できます。",
            "focus": "deliver",
            "object": "the finished products"
          },
          {
            "en": "They delivered the replacement unit without delay.",
            "ja": "彼らは遅れずに交換品を納品しました。",
            "focus": "delivered",
      ...
      {
        "id": "deliver-performance",
        "title": "⑥ 期待される働きをする",
        "pattern": "deliver + performance/quality",
        "transitivity": "他動詞",
        "structure": "S + deliver + O",
        "image": "製品やチームが期待される性能や品質を発揮する。",
        "point": "製品性能やチームの実績を説明する時に使えます。",
        "examples": [
          {
            "en": "The new model delivers stable performance.",
            "ja": "新モデルは安定した性能を発揮します。",
            "focus": "delivers",
            "object": "stable performance"
          },
          {
            "en": "This system delivered the required quality.",
            "ja": "このシステムは求められた品質を実現しました。",
            "focus": "delivered",
            "object": "the required quality"
          },
          {
            "en": "The project must deliver measurable benefits.",
            "ja": "この案件では目に見える効果を出す必要があります。",
            "focus": "deliver",
    ...
    "phrasalVerbs": [
      ...
      },
      {
        "phrase": "deliver on",
        "ja": "約束・期待に応える",
        "image": "約束や期待を実際の結果として実現する。",
        "pattern": "deliver on + promise/expectation",
        "examples": [
          {
            "en": "We must deliver on our promise to the customer.",
            "ja": "私たちは顧客との約束を果たさなければなりません。",
            "focus": "deliver on"
          },
          {
          ...
          {
            "en": "The project team delivered on its commitment.",
            "ja": "プロジェクトチームは約束したことを実行しました。",
            "focus": "delivered on"
          }
        ],
        "dailyExamples": []
    ...
    "meanings": [
      {
        "id": "solve-problem",
        "title": "① 問題・不具合を解決する",
        "pattern": "solve + problem/issue/error",
        "transitivity": "他動詞",
        "structure": "S + solve + O",
        "image": "問題の原因を見つけ、解決した状態にする。",
        "point": "solve the problem / solve the issue が最も基本です。",
        "examples": [
          {
            "en": "We need to solve this issue today.",
            "ja": "私たちは今日、この問題を解決する必要があります。",
            "focus": "solve",
            "object": "this issue"
          },
          {
            "en": "The team solved the problem after checking the wiring.",
            "ja": "チームは配線を確認した後、問題を解決しました。",
            "focus": "solved",
            "object": "the problem"
          },
          {
            "en": "Can you solve this error before the test?",
            "ja": "あなたは試験前にこのエラーを解決できますか？",
            "focus": "solve",
            "object": "this error"
          }
        ]
      ...
      },
      {
        "id": "solve-technical",
        "title": "③ 技術的な問題を解決する",
        "pattern": "solve + technical problem",
        "transitivity": "他動詞",
        "structure": "S + solve + O",
        "image": "技術・製品・施工に関する問題を解消する。",
        "point": "現場対応や技術サポートで使いやすい表現です。",
        "examples": [
          {
            "en": "The engineer solved a technical problem at the site.",
            "ja": "技術者は現場で技術的な問題を解決しました。",
            "focus": "solved",
            "object": "a technical problem"
          },
          {
            "en": "We need more information to solve the control issue.",
            "ja": "制御上の問題を解決するには、さらに情報が必要です。",
            "focus": "solve",
            "object": "the control issue"
          },
          {
            "en": "The new connector solved the wiring problem.",
            "ja": "新しいコネクターによって配線の問題が解決しました。",
            "focus": "solved",
      ...
      },
      {
        "id": "solve-challenge",
        "title": "④ 課題を解決する",
        "pattern": "solve + challenge",
        "transitivity": "他動詞",
        "structure": "S + solve + O",
        "image": "難しい課題に対して実行可能な答えを出す。",
        "point": "challenge は、仕事上の難しい課題を表します。",
        "examples": [
          {
          ...
          {
            "en": "The team solved several production challenges.",
            "ja": "チームは生産上の課題をいくつか解決しました。",
            "focus": "solved",
            "object": "several production challenges"
          },
          {
            "en": "This proposal may solve the space limitation.",
      ...
      },
      {
        "id": "solve-question",
        "title": "⑤ 問題や謎の答えを出す",
        "pattern": "solve + question/mystery/puzzle",
        "transitivity": "他動詞",
        "structure": "S + solve + O",
        "image": "答えが分からない問題や謎を解く。",
        "point": "計算問題、謎、原因不明の問題にも使えます。",
        "examples": [
          {
            "en": "She solved the calculation correctly.",
            "ja": "彼女はその計算問題を正しく解きました。",
            "focus": "solved",
            "object": "the calculation"
          },
          {
            "en": "The test helped us solve the mystery.",
            "ja": "その試験によって原因不明だった問題を解明できました。",
            "focus": "solve",
            "object": "the mystery"
          },
          {
            "en": "Can you solve this puzzle?",
            "ja": "あなたはこのパズルを解けますか？",
            "focus": "solve",
            "object": "this puzzle"
          }
      ...
      {
        "id": "solve-permanently",
        "title": "⑥ 問題を根本的に解決する",
        "pattern": "solve + problem + permanently",
        "transitivity": "他動詞",
        "structure": "S + solve + O + M",
        "image": "一時対応ではなく、問題が再発しない状態にする。",
        "point": "root cause は solve せず、問題そのものを根本的に解決すると表現します。",
        "examples": [
          {
            "en": "We need to solve the problem permanently.",
            "ja": "私たちはその問題を根本的に解決する必要があります。",
            "focus": "solve",
            "object": "the problem"
          },
          {
            "en": "The design change solved the issue for good.",
            "ja": "設計変更によって、その問題は完全に解決しました。",
            "focus": "solved",
            "object": "the issue"
          },
          {
            "en": "A temporary fix will not solve the problem.",
            "ja": "一時的な修正では、その問題は解決しません。",
            "focus": "solve",
            "object": "the problem"
          }
        ]
    ...
    "phrasalVerbs": [
      {
        ...
        "examples": [
          ...
          },
          {
            ...
            "ja": "彼らは別の配送ルートを使うことで遅延問題を解決しました。",
            "focus": "solved by"
          },
          {
            "en": "You can solve this error by updating the settings.",
            "ja": "設定を更新することで、このエラーを解決できます。",
            "focus": "solve by"
          }
        ],
        "dailyExamples": []
      },
      {
        ...
        "examples": [
          ...
          {
            "en": "This problem can be solved with less wiring.",
            "ja": "この問題は、より少ない配線で解決できます。",
            "focus": "solved with"
          }
        ],
        "dailyExamples": []
      },
      {
        "phrase": "solve for",
        "ja": "条件を考慮して答えを出す・求める",
        "image": "条件や制約を踏まえて最適な答えを考える。",
        "pattern": "solve for + condition/variable",
        "examples": [
          {
            "en": "This design solves for limited installation space.",
            "ja": "この設計は、限られた設置スペースを考慮した解決策です。",
            "focus": "solves for"
          },
          {
            "en": "We need to solve for both cost and performance.",
            "ja": "コストと性能の両方を考慮して答えを出す必要があります。",
            "focus": "solve for"
          },
          {
            "en": "The engineer solved for the correct voltage.",
            "ja": "技術者は正しい電圧値を求めました。",
            "focus": "solved for"
          }
        ],
  ...
  },
  {
    ...
    "transitivity": "他動詞・自動詞",
    "importance": "★★★☆☆ 基本",
    "core": "事実や状況を整理して相手に伝える",
    "coreDetail": "REPORTは、状況・結果・問題・数字などを整理して、上司・チーム・顧客に報告する動詞です。仕事では report the result / report a problem / report that ... の形が重要です。",
    "coreVisual": {
      "from": [
        "結果",
        "進捗",
      ...
      "to": "上司・チーム・顧客",
      "label": "確認した内容を整理して伝える"
    },
    "meanings": [
      {
        "id": "report-result",
        "title": "① 結果・状況を報告する",
        "pattern": "report + result/status",
        "transitivity": "他動詞",
        "structure": "S + report + O",
        "image": "確認した結果や現在の状況を伝える。",
        "point": "result / status / progress などを目的語にできます。",
        "examples": [
          {
            "en": "I reported the test result this morning.",
            "ja": "私は今朝、試験結果を報告しました。",
            "focus": "reported",
            "object": "the test result"
          },
          {
            "en": "Please report the current status by noon.",
            "ja": "正午までに現在の状況を報告してください。",
            "focus": "report",
            "object": "the current status"
          },
          {
            "en": "We report progress at the weekly meeting.",
            "ja": "私たちは週次会議で進捗を報告します。",
            "focus": "report",
            "object": "progress"
          }
        ]
      },
      {
        "id": "report-problem",
        "title": "② 問題・不具合を報告する",
        "pattern": "report + problem/issue/error",
        "transitivity": "他動詞",
        "structure": "S + report + O",
        "image": "発見した問題や不具合を関係者に伝える。",
        "point": "問題を見つけた時の社内連絡や顧客対応で使います。",
        "examples": [
          {
            "en": "The installer reported a wiring problem.",
            "ja": "施工担当者は配線上の問題を報告しました。",
            "focus": "reported",
            "object": "a wiring problem"
          },
          {
            "en": "Please report any damage immediately.",
            "ja": "損傷があれば、すぐに報告してください。",
            "focus": "report",
            "object": "any damage"
          },
          {
            "en": "The customer reported an error in the system.",
      ...
      },
      {
        ...
        "image": "確認した事実や判断を文の形で伝える。",
        "point": "that節を使うと、報告内容を具体的に説明できます。",
        "examples": [
          {
            "en": "The factory reported that production was delayed.",
            "ja": "工場は生産が遅れていると報告しました。",
            "focus": "reported",
            "object": "that production was delayed"
          },
          {
            "en": "She reported that the sample had arrived.",
            "ja": "彼女はサンプルが到着したと報告しました。",
            "focus": "reported",
            "object": "that the sample had arrived"
          },
          {
            "en": "We reported that the issue had been resolved.",
            "ja": "私たちは問題が解決したと報告しました。",
            "focus": "reported",
      ...
      },
      {
        "id": "report-what",
        "title": "④ 起きたことを報告する",
        "pattern": "report + what/when/how ...",
        "transitivity": "他動詞",
        "structure": "S + report + wh節",
        "image": "出来事の内容や経緯を具体的に伝える。",
        "point": "what happened / how it happened などを続けられます。",
        "examples": [
          {
            "en": "Please report what happened at the site.",
            "ja": "現場で何が起きたのか報告してください。",
            "focus": "report",
            "object": "what happened"
          },
          {
            "en": "He reported how the problem started.",
            "ja": "彼は問題がどのように始まったか報告しました。",
            "focus": "reported",
            "object": "how the problem started"
          },
          {
            "en": "We need to report when the delay occurred.",
      ...
      },
      {
        "id": "report-figures",
        "title": "⑤ 数字・実績を報告する",
        "pattern": "report + sales/cost/figures",
        "transitivity": "他動詞",
        "structure": "S + report + O",
        "image": "売上、費用、数量などの数字を伝える。",
        "point": "営業実績や予算の共有で使いやすい意味です。",
        "examples": [
          {
            "en": "The sales team reported higher revenue this month.",
            "ja": "営業チームは今月、売上が増えたと報告しました。",
            "focus": "reported",
            "object": "higher revenue"
          },
          {
            "en": "Please report the final cost after installation.",
            "ja": "設置後に最終費用を報告してください。",
            "focus": "report",
            "object": "the final cost"
          },
          {
            "en": "Each branch reports its monthly figures.",
            "ja": "各支店は毎月の実績数値を報告します。",
            "focus": "reports",
      ...
      },
      {
        "id": "report-formally",
        "title": "⑥ 正式に届け出る・申告する",
        "pattern": "report + incident/loss/absence",
        "transitivity": "他動詞",
        "structure": "S + report + O",
        "image": "事故、紛失、欠勤などを正式な手続きで伝える。",
        "point": "社内規則や公的な届け出にも使われます。",
        "examples": [
          {
            "en": "You must report the incident to your supervisor.",
            "ja": "あなたはその出来事を上司に報告しなければなりません。",
            "focus": "report",
            "object": "the incident"
          },
          {
            "en": "She reported the lost equipment immediately.",
            "ja": "彼女は機器の紛失をすぐに届け出ました。",
            "focus": "reported",
            "object": "the lost equipment"
          },
          {
            "en": "Employees should report any safety concerns.",
            "ja": "従業員は安全上の懸念があれば報告すべきです。",
            "focus": "report",
    ...
    "phrasalVerbs": [
      {
        ...
        "examples": [
          ...
          {
            "en": "I report directly to the sales director.",
            "ja": "私は営業部長直属です。",
            "focus": "report to"
          },
          {
            "en": "The local office reports to headquarters.",
            "ja": "現地オフィスは本社の管轄下にあります。",
            "focus": "reports to"
          }
        ],
        "dailyExamples": []
      },
      {
        ...
        "ja": "〜について報告する",
        "image": "報告するテーマや対象を示す。",
        "pattern": "report on + topic",
        "examples": [
          {
            "en": "She reported on the project status.",
            "ja": "彼女は案件の進捗について報告しました。",
            "focus": "reported on"
          },
          {
            "en": "I will report on the test results tomorrow.",
            "ja": "明日、試験結果について報告します。",
            "focus": "report on"
          },
          {
            "en": "The team reports on sales performance every month.",
            "ja": "チームは毎月、営業実績について報告します。",
            "focus": "reports on"
          }
        ],
        "dailyExamples": []
      },
      {
        "phrase": "report back",
        "ja": "確認後に報告する",
        "image": "確認や対応を行った後で、結果を戻して伝える。",
        "pattern": "report back (+ to + 人)",
        "examples": [
          {
            "en": "Please check the site and report back.",
            "ja": "現場を確認して、結果を報告してください。",
            "focus": "report back"
          },
          {
            "en": "I will report back to you after the meeting.",
            "ja": "会議後にあなたへ報告します。",
            "focus": "report back"
          },
          {
            "en": "The engineer reported back with the test results.",
            "ja": "技術者は試験結果を持ち帰って報告しました。",
            "focus": "reported back"
          }
        ],
        "dailyExamples": []
...
},
  {
      ...
      "coreDetail": "AGREEは、自分の考えや判断が相手・提案・条件と同じ方向にそろうイメージです。仕事では agree with 人・意見、agree to 提案・条件、agree on 日程・価格・条件を使い分けます。",
      "coreVisual": {"from":["👤 自分の意見","💬 相手の意見","📄 条件","📅 日程"],"to":"✅ 同じ方向にそろう","label":"意見・条件 → 合意"},
      "meanings": [
          {
              "id":"agree-that","title":"① 〜だという点で意見が一致する","pattern":"AGREE THAT + 文","transitivity":"自動詞","structure":"S + agree that + 文","image":"判断や認識が同じになる。","point":"thatの後ろに文を置き、共通認識を示す。",
              "examples":[
                  {"en":"We agreed that the schedule was too tight.","ja":"私たちはスケジュールが厳しすぎるという点で意見が一致しました。","focus":"agreed"},
                  {"en":"Everyone agreed that we needed more information.","ja":"全員が、さらに情報が必要だという点で同意しました。","focus":"agreed"},
                  {"en":"The managers agreed that the issue was urgent.","ja":"管理者たちは、その問題が緊急だという点で意見が一致しました。","focus":"agreed"}
              ]
          },
          {
              "id":"agree-to-do","title":"② 〜することを承諾する","pattern":"AGREE TO DO","transitivity":"自動詞","structure":"S + agree to do","image":"依頼や提案を受け入れて行動する。","point":"toの後ろに動詞を置き、何かをすることを承諾する。",
              "examples":[
                  {"en":"The supplier agreed to send the samples today.","ja":"仕入先は本日サンプルを送ることを承諾しました。","focus":"agreed"},
                  {"en":"We agreed to review the contract again.","ja":"私たちは契約書を再確認することに同意しました。","focus":"agreed"},
                  {"en":"The client agreed to wait until Friday.","ja":"顧客は金曜日まで待つことに同意しました。","focus":"agreed"}
              ]
          },
          {
              "id":"agree-in-principle","title":"③ 基本的に合意する","pattern":"AGREE IN PRINCIPLE","transitivity":"自動詞","structure":"S + agree in principle","image":"細部は未確定でも大枠では同意する。","point":"詳細条件は残っているが、方向性として合意したときに使う。",
              "examples":[
                  {"en":"We agreed in principle to move forward with the project.","ja":"私たちはその案件を進める方向で基本合意しました。","focus":"agreed"},
                  {"en":"The client agreed in principle, but requested a lower price.","ja":"顧客は基本的に同意しましたが、値下げを求めました。","focus":"agreed"},
                  {"en":"Management agreed in principle to the new plan.","ja":"経営陣は新しい計画に基本合意しました。","focus":"agreed"}
              ]
          }
      ],
      "collocations": [],
      "phrasalVerbs": [
          {
              "phrase":"agree with","ja":"人・意見に同意する／内容と一致する","image":"相手の意見と同じ立場になる。または情報同士が一致する。","pattern":"agree with + 人/意見/情報",
              "examples":[
                  {"en":"I agree with your idea.","ja":"私はあなたの考えに同意します。","focus":"agree with"},
                  {"en":"We agreed with the client that the concern was valid.","ja":"私たちは、その懸念がもっともだという点で顧客と意見が一致しました。","focus":"agreed with"},
                  {"en":"The figures do not agree with the latest report.","ja":"その数字は最新の報告書と一致していません。","focus":"agree with"}
              ]
          },
          {
              "phrase":"agree to","ja":"提案・条件を受け入れる","image":"提示された提案や条件を受け入れる。","pattern":"agree to + 提案/条件",
              "examples":[
                  {"en":"The client agreed to the revised estimate.","ja":"顧客は修正見積に同意しました。","focus":"agreed to"},
                  {"en":"We agreed to the payment terms.","ja":"私たちは支払条件に同意しました。","focus":"agreed to"},
                  {"en":"Management agreed to the proposed change.","ja":"経営陣は提案された変更を受け入れました。","focus":"agreed to"}
              ]
          },
          {
              "phrase":"agree on","ja":"日程・価格・条件について合意する","image":"話し合いの結果、具体的な内容を1つに決める。","pattern":"agree on + 内容",
              "examples":[
                  {"en":"We agreed on the delivery date.","ja":"私たちは納品日に合意しました。","focus":"agreed on"},
                  {"en":"Both companies agreed on the final price.","ja":"両社は最終価格に合意しました。","focus":"agreed on"},
                  {"en":"The team agreed on the project scope.","ja":"チームはプロジェクト範囲について合意しました。","focus":"agreed on"}
              ]
          },
          {
              "phrase":"agree about","ja":"話題について意見が一致する","image":"ある話題について同じ考えを持つ。","pattern":"agree about + 話題",
              "examples":[
                  {"en":"We agree about the need for better communication.","ja":"私たちは、より良い情報共有が必要だという点で意見が一致しています。","focus":"agree about"},
                  {"en":"The two teams agreed about what caused the delay.","ja":"両チームは遅延の原因について意見が一致しました。","focus":"agreed about"},
                  {"en":"We do not always agree about priorities.","ja":"私たちは優先順位について、いつも意見が一致するとは限りません。","focus":"agree about"}
              ]
          }
      ]
  },
  {
      "id":"arrange","rank":74,"word":"ARRANGE","ipa":"/əˈreɪndʒ/","kana":"アレンジ","syllable":"ar-range","transitivity":"他動詞・自動詞","importance":"★★★☆☆ 基本",
      "core":"人・物・予定を目的に合う形へ整える","coreDetail":"ARRANGEは、会議・配送・移動・資料・人員などを目的に合うように手配・調整・配置するイメージです。仕事では『段取りを整える』意味が中心です。",
      "coreVisual":{"from":["📅 予定","🚚 配送","👥 人員","📄 資料","🪑 配置"],"to":"🗂️ 整った段取り","label":"バラバラ → 目的に合う形へ"},
      "meanings":[
          {"id":"arrange-meeting","title":"① 会議・予定を手配する","pattern":"ARRANGE + 会議/予定","transitivity":"他動詞","structure":"S + arrange + O","image":"必要な予定を組んで実行できる状態にする。","point":"meeting, call, appointmentなどと相性が良い。","examples":[
              {"en":"I arranged a meeting with the client.","ja":"私は顧客との打ち合わせを手配しました。","focus":"arranged","object":"a meeting"},
              {"en":"We arranged a call for Thursday afternoon.","ja":"私たちは木曜午後に電話会議を設定しました。","focus":"arranged","object":"a call"},
              {"en":"She arranged an appointment with the manager.","ja":"彼女はマネージャーとの面談を手配しました。","focus":"arranged","object":"an appointment"}
          ]},
          {"id":"arrange-delivery","title":"② 配送・移動を手配する","pattern":"ARRANGE + 配送/移動","transitivity":"他動詞","structure":"S + arrange + O","image":"必要な物や人が予定どおり動くよう段取りを整える。","point":"delivery, shipment, transportationなどと使う。","examples":[
              {"en":"We arranged the delivery for next Monday.","ja":"私たちは次の月曜日に納品を手配しました。","focus":"arranged","object":"the delivery"},
              {"en":"The office arranged transportation for the guests.","ja":"会社は来客用の移動手段を手配しました。","focus":"arranged","object":"transportation"},
              {"en":"I arranged the shipment for the end of the month.","ja":"私は月末の出荷を手配しました。","focus":"arranged","object":"the shipment"}
          ]},
          {"id":"arrange-to-do","title":"③ 〜する段取りを整える","pattern":"ARRANGE TO DO","transitivity":"自動詞","structure":"S + arrange to do","image":"必要な調整を行い、行動できる状態にする。","point":"to不定詞を使い、訪問・面談・確認などを行う段取りを表す。","examples":[
              {"en":"We arranged to visit the site tomorrow.","ja":"私たちは明日、現場を訪問する段取りを整えました。","focus":"arranged"},
              {"en":"The team arranged to review the details on Friday.","ja":"チームは金曜日に詳細を確認することにしました。","focus":"arranged"},
              {"en":"I arranged to speak with the client after lunch.","ja":"私は昼食後に顧客と話す予定を組みました。","focus":"arranged"}
          ]},
          {"id":"arrange-items","title":"④ 物や資料を整理して並べる","pattern":"ARRANGE + 物/資料","transitivity":"他動詞","structure":"S + arrange + O","image":"物を分かりやすい順番や位置に整える。","point":"資料、椅子、商品、ファイルなどを目的に合う形で並べる。","examples":[
              {"en":"Please arrange the documents before the meeting.","ja":"会議前に資料を整理してください。","focus":"arrange","object":"the documents"},
              {"en":"We arranged the chairs for the seminar.","ja":"私たちはセミナー用に椅子を配置しました。","focus":"arranged","object":"the chairs"},
              {"en":"She arranged the product samples neatly.","ja":"彼女は商品サンプルをきれいに並べました。","focus":"arranged","object":"the product samples"}
          ]}
      ],
      "collocations":[],
      "phrasalVerbs":[
          {"phrase":"arrange for","ja":"人・物が動くように手配する","image":"自分が直接行うのではなく、必要な人や物が動く段取りを作る。","pattern":"arrange for + 人/物 + to do","examples":[
              {"en":"I arranged for a technician to visit the site.","ja":"私は技術者が現場を訪問するよう手配しました。","focus":"arranged for"},
              {"en":"We arranged for the samples to arrive tomorrow.","ja":"私たちはサンプルが明日届くよう手配しました。","focus":"arranged for"},
              {"en":"She arranged for a car to pick up the client.","ja":"彼女は車が顧客を迎えに行くよう手配しました。","focus":"arranged for"}
          ]},
          {"phrase":"arrange with","ja":"〜と相談して段取りを決める","image":"相手と連絡を取り、予定や方法を調整する。","pattern":"arrange with + 相手 + to do","examples":[
              {"en":"We arranged with the client to meet on Friday.","ja":"私たちは金曜日に会うことで顧客と調整しました。","focus":"arranged with"},
              {"en":"I arranged with the warehouse to ship the goods tomorrow.","ja":"私は明日商品を出荷するよう倉庫と調整しました。","focus":"arranged with"},
              {"en":"She arranged with the site manager to start at nine.","ja":"彼女は9時に開始することで現場責任者と調整しました。","focus":"arranged with"}
          ]},
          {"phrase":"arrange by","ja":"基準・項目別に整理する","image":"決めた基準に沿って物や情報を並べ替える。","pattern":"arrange + 物 + by + 基準","examples":[
              {"en":"Please arrange the files by project name.","ja":"ファイルを案件名ごとに整理してください。","focus":"arrange by"},
              {"en":"We arranged the products by size.","ja":"私たちは製品をサイズ別に並べました。","focus":"arranged by"},
              {"en":"The data is arranged by month.","ja":"データは月別に整理されています。","focus":"arranged by"}
          ]},
          {"phrase":"arrange in","ja":"形・順番に並べる","image":"物や情報を一定の形や順序に整える。","pattern":"arrange + 物 + in + 形/順番","examples":[
              {"en":"Please arrange the chairs in a circle.","ja":"椅子を円形に並べてください。","focus":"arrange in"},
              {"en":"We arranged the steps in the correct order.","ja":"私たちは手順を正しい順番に並べました。","focus":"arranged in"},
              {"en":"The samples were arranged in three rows.","ja":"サンプルは3列に並べられていました。","focus":"arranged in"}
          ]},
          {"phrase":"arrange on","ja":"〜の上に並べる","image":"物を台・机・棚などの上に配置する。","pattern":"arrange + 物 + on + 場所","examples":[
              {"en":"Please arrange the samples on the table.","ja":"サンプルをテーブルの上に並べてください。","focus":"arrange on"},
              {"en":"She arranged the brochures on the counter.","ja":"彼女はパンフレットをカウンターに並べました。","focus":"arranged on"},
              {"en":"The products were arranged on the display shelf.","ja":"製品は展示棚に並べられていました。","focus":"arranged on"}
          ]}
      ]
  },
  {
      "id":"attend","rank":75,"word":"ATTEND","ipa":"/əˈtend/","kana":"アテンド","syllable":"at-tend","transitivity":"他動詞・自動詞","importance":"★★★☆☆ 基本",
      "core":"必要な場所・相手・問題に意識と時間を向ける","coreDetail":"ATTENDは、会議や研修に出席する意味が中心です。attend toでは問題・顧客・細部に対応します。日本語の『お客様をアテンドする』は通常、英語では accompany、guide、assistなどを使います。",
      "coreVisual":{"from":["👤 自分/担当者"],"to":"🏢 会議・研修・問題へ向かう","label":"意識と時間を向ける"},
      "meanings":[
          {"id":"attend-meeting","title":"① 会議・イベントに出席する","pattern":"ATTEND + 会議/イベント","transitivity":"他動詞","structure":"S + attend + O","image":"必要な場所に行き、その場に参加する。","point":"attendの後ろにmeeting, seminar, exhibitionなどを直接置く。attend to the meetingとは言わない。","examples":[
              {"en":"I attended the meeting this morning.","ja":"私は今朝その会議に出席しました。","focus":"attended","object":"the meeting"},
              {"en":"We attended the sales conference last week.","ja":"私たちは先週、営業会議に出席しました。","focus":"attended","object":"the sales conference"},
              {"en":"They will attend the exhibition in Tokyo.","ja":"彼らは東京の展示会に参加する予定です。","focus":"attend","object":"the exhibition"}
          ]},
          {"id":"attend-training","title":"② 研修・授業に参加する","pattern":"ATTEND + 研修/授業","transitivity":"他動詞","structure":"S + attend + O","image":"学ぶための場に参加する。","point":"training, class, workshop, courseなどと相性が良い。","examples":[
              {"en":"We attended a product training session.","ja":"私たちは製品研修に参加しました。","focus":"attended","object":"a product training session"},
              {"en":"New staff must attend the safety workshop.","ja":"新入社員は安全講習に参加する必要があります。","focus":"attend","object":"the safety workshop"},
              {"en":"She attended an online course on project management.","ja":"彼女はプロジェクト管理のオンライン講座に参加しました。","focus":"attended","object":"an online course"}
          ]},
          {"id":"attend-remotely","title":"③ オンライン・遠隔で参加する","pattern":"ATTEND + 会議/研修 + REMOTELY/ONLINE","transitivity":"他動詞","structure":"S + attend + O + M","image":"現地ではなくオンラインで参加する。","point":"remotelyやonlineは参加方法を示す。","examples":[
              {"en":"I attended the meeting remotely.","ja":"私はその会議にリモートで参加しました。","focus":"attended","object":"the meeting"},
              {"en":"Several members attended the training online.","ja":"数名のメンバーは研修にオンラインで参加しました。","focus":"attended","object":"the training"},
              {"en":"The client attended the review session by video call.","ja":"顧客はビデオ会議でレビュー会に参加しました。","focus":"attended","object":"the review session"}
          ]},
          {"id":"required-to-attend","title":"④ 出席が必要な場面","pattern":"BE REQUIRED/EXPECTED TO ATTEND","transitivity":"他動詞","structure":"S + be required/expected to attend + O","image":"業務上、参加が必要とされる。","point":"会社や顧客から参加を求められる場面で使う。","examples":[
              {"en":"All sales staff are required to attend the briefing.","ja":"営業担当者全員が説明会に出席する必要があります。","focus":"attend","object":"the briefing"},
              {"en":"The project leader is expected to attend the client meeting.","ja":"プロジェクトリーダーは顧客との会議に出席することが期待されています。","focus":"attend","object":"the client meeting"},
              {"en":"Participants are required to attend the full session.","ja":"参加者は全セッションに出席する必要があります。","focus":"attend","object":"the full session"}
          ]},
          {"id":"attend-as","title":"⑤ 役割を持って参加する","pattern":"ATTEND + イベント + AS + 役割","transitivity":"他動詞","structure":"S + attend + O + as + 役割","image":"役割を持って会議やイベントに参加する。","point":"representative, observer, speakerなどの役割を示す。","examples":[
              {"en":"I attended the meeting as a sales representative.","ja":"私は営業担当者としてその会議に出席しました。","focus":"attended"},
              {"en":"She attended the seminar as a guest speaker.","ja":"彼女はゲスト講師としてセミナーに参加しました。","focus":"attended"},
              {"en":"We attended the inspection as observers.","ja":"私たちは立会人として検査に参加しました。","focus":"attended"}
          ]},
          {"id":"attend-regularly","title":"⑥ 定期的な会議・講座に参加する","pattern":"ATTEND + 定期的な会議/講座","transitivity":"他動詞","structure":"S + attend + O","image":"定例会や講座などに継続的に参加する。","point":"weekly, monthlyなど、定期的な活動と一緒に使う。","examples":[
              {"en":"He attends the weekly project meeting.","ja":"彼は毎週のプロジェクト会議に出席しています。","focus":"attends","object":"the weekly project meeting"},
              {"en":"Our team attends monthly safety training.","ja":"私たちのチームは毎月の安全研修に参加しています。","focus":"attends","object":"monthly safety training"},
              {"en":"She attends an English class after work.","ja":"彼女は仕事後に英語クラスに通っています。","focus":"attends","object":"an English class"}
          ]}
      ],
      "collocations":[],
      "phrasalVerbs":[
          {"phrase":"attend to","ja":"対応する・注意を向ける","image":"人・問題・細部に意識を向けて対応する。会議に出席するattendとは意味が違う。","pattern":"attend to + 人/問題/用件","examples":[
              {"en":"Please attend to this issue as soon as possible.","ja":"できるだけ早くこの問題に対応してください。","focus":"attend to"},
              {"en":"The support team is attending to the client's request.","ja":"サポートチームは顧客の依頼に対応しています。","focus":"attending to"},
              {"en":"We need to attend to every detail before launch.","ja":"開始前にすべての細部に注意を払う必要があります。","focus":"attend to"}
          ]}
      ]
  },
  {
