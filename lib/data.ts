...
export const verbs: Verb[] = [
    ...
    "phrasalVerbs": [
      {
        ...
        "examples": [
          {
            "en": "Please hold on for a moment.",
            "ja": "少々お待ちください。",
            "focus": "hold on",
            "jaFocus": "待つ"
          }
  ...
  },
  {
    ...
    "importance": "★★★★★ 基本",
    "core": "変える・変更する",
    "coreDetail": "CHANGEは、予定・内容・デザイン・条件などを変える時に使う基本動詞です。",
    "meanings": [
      {
        "id": "main",
        "title": "① 変更する",
        "pattern": "change + 名詞",
        "transitivity": "他動詞・自動詞",
        "structure": "S + change + O",
        "image": "今の状態を別の状態にする",
        "point": "change は変更対象を目的語に置きます。仕事では schedule, details, design などとよく使います。",
        "examples": [
          {
          ...
          {
            "en": "The design changed after the review.",
            "ja": "レビュー後にデザインが変更されました。",
            "focus": "changed",
            "jaFocus": "変更された"
          }
        ],
  ...
  },
  {
    ...
    "importance": "★★★★☆ 基本",
    "core": "支払う・注意を向ける",
    "coreDetail": "PAYは、お金を支払う時だけでなく pay attention to ... で「注意を払う」にも使います。",
    "meanings": [
      {
        "id": "main",
        "title": "① 支払う",
        "pattern": "pay + 金額・請求書 / pay + 人",
        "transitivity": "他動詞・自動詞",
        "structure": "S + pay + O",
        "image": "お金や注意を相手・対象に向ける",
        "point": "pay the invoice は「請求書を支払う」。pay attention to は「注意を払う」です。",
        "examples": [
          {
            "en": "We paid the invoice yesterday.",
            "ja": "私たちは昨日、その請求書を支払いました。",
            "focus": "paid the invoice",
            "jaFocus": "請求書を支払った",
            "object": "the invoice",
            "sentencePattern": "S + V + O",
            "grammarParts": [
          ...
          {
            "en": "Please pay attention to the delivery date.",
            "ja": "納期に注意してください。",
            "focus": "pay attention to",
            "jaFocus": "注意する"
          },
          {
            "en": "The customer paid by bank transfer.",
            "ja": "その顧客は銀行振込で支払いました。",
            "focus": "paid",
            "jaFocus": "支払った"
          }
  ...
  },
  {
    ...
    "importance": "★★★★★ 基本",
    "core": "買う・購入する",
    "coreDetail": "BUYは、必要な物や材料を購入する時に使う基本動詞です。",
    "meanings": [
      {
        "id": "main",
        "title": "① 買う・購入する",
        ...
        "structure": "S + buy + O",
        "image": "お金を払って手に入れる",
        "point": "buy は purchase より日常的です。仕事では buy samples / buy parts などが使えます。",
        "examples": [
          {
            "en": "We bought sample parts for the project.",
            "ja": "私たちはその案件用にサンプル部品を購入しました。",
            "focus": "bought sample parts",
            "jaFocus": "サンプル部品を購入した",
            "object": "sample parts",
            "sentencePattern": "S + V + O",
            "grammarParts": [
          ...
          {
            "en": "I need to buy a new charger today.",
            "ja": "私は今日、新しい充電器を買う必要があります。",
            "focus": "buy a charger",
            "jaFocus": "充電器を買う"
          },
          {
            "en": "The company bought new equipment last month.",
            "ja": "その会社は先月、新しい設備を購入しました。",
            "focus": "bought equipment",
            "jaFocus": "設備を購入した"
          }
        ],
        "dailyExamples": [
    ...
    "meanings": [
      {
        ...
        "examples": [
          {
            "en": "We decided to change the schedule.",
            "ja": "私たちはスケジュールを変更することに決めました。",
            "focus": "decided",
            ...
            "grammarParts": [
              ...
              {
                "label": "O",
                "text": "to change the schedule"
              }
            ],
            "grammarNote": "to change the schedule は decided の内容を表します。"
          },
          {
            "en": "Did you decide on the meeting date?",
            "ja": "あなたは会議の日程を決めましたか？",
            "focus": "decide on",
          ...
          {
            "en": "The client decided to approve the design.",
            "ja": "クライアントはそのデザインを承認することに決めました。",
            "focus": "decided",
            "object": "to approve the design",
            "jaFocus": "決めました"
          }
        ]
      }
    ...
    "collocations": [
      {
        "phrase": "decide on",
        "ja": "〜に決める",
        "image": "on は決定がその対象に乗るイメージ。",
        "pattern": "decide on + 名詞",
        "examples": [
          {
            "en": "We need to decide on the final color.",
            "ja": "私たちは最終色を決める必要があります。",
            "focus": "decide on",
            "object": "the final color",
            "jaFocus": "決める"
          },
          {
            "en": "Have you decided on a hotel?",
            "ja": "あなたはホテルを決めましたか？",
            "focus": "decided on",
            "object": "a hotel",
            "jaFocus": "決めましたか"
        ...
        "examples": [
          {
            ...
            "grammarNote": "to the client は説明する相手を表します。"
          },
          {
            "en": "Can you explain the process again?",
            "ja": "あなたはその手順をもう一度説明できますか？",
            "focus": "explain",
            "object": "the process",
            "jaFocus": "説明できますか"
          },
          {
            "en": "She explained that the delivery was delayed.",
            "ja": "彼女は納品が遅れていると説明しました。",
            "focus": "explained",
            "object": "that the delivery was delayed",
            "jaFocus": "説明しました"
          }
        ]
      }
    ...
    "meanings": [
      {
        ...
        "examples": [
          {
            "en": "We discussed the schedule with the client.",
            "ja": "私たちはクライアントとスケジュールについて話し合いました。",
            "focus": "discussed",
            "object": "the schedule",
            "jaFocus": "話し合いました"
          },
          {
            "en": "Let's discuss the issue after lunch.",
            "ja": "昼食後にその問題について話し合いましょう。",
            "focus": "discuss",
            "object": "the issue",
            "jaFocus": "話し合いましょう"
          },
          {
            "en": "Did you discuss the price with them?",
            "ja": "あなたは彼らと価格について話し合いましたか？",
            "focus": "discuss",
            "object": "the price",
            "jaFocus": "話し合いましたか"
          }
    ...
    "meanings": [
      {
        ...
        "examples": [
          ...
          {
            "en": "Did you receive the sample?",
            "ja": "あなたはサンプルを受け取りましたか？",
            "focus": "receive",
            "object": "the sample",
            "jaFocus": "受け取りましたか"
          }
